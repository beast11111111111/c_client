    ...
    return (
        <>
            <div class=" overflow-visible transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 bg-white border rounded-lg bg-opacity-20 backdrop-blur-lg border rounded-lg ">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjwIzW7yUGeuDE-KH5ZZdQ3mwlsU2GtcU68g&s" style={{height:"250px",width:"183.04px"}}></img>
                <div class="p-6">
                    ...
                    <h4 class="font-semibold  text-white italic"> Toothpaste </h4>
                    <div class="mt-1">
                        ...
                        <h6 class=" font-semibold text-white italic text-sm">Price 150</h6>
                    </div>
